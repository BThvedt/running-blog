...
"use strict";
/*!*********************************************!*\
  !*** ./src/blocks/review-stars/frontend.js ***!
  \*********************************************/
...
function ReviewRating(props) {
  ...
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(react_star_ratings__WEBPACK_IMPORTED_MODULE_1__["default"], {
    rating: parseFloat(rating),
    starRatedColor: "blue",
    numberOfStars: 6,
    isSelectable: false,
    name: "rating"
  }), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("h1", null, "Rendering the element ", rating, " ", typeof rating))
  // <StarRatings
  //   rating={rating}
  //   starRatedColor="blue"
  //   numberOfStars={6}
...
document.addEventListener("DOMContentLoaded", () => {
  var _block$dataset, _block$dataset2;
  const block = document.querySelector("#review-rating");
  const postID = block === null || block === void 0 ? void 0 : (_block$dataset = block.dataset) === null || _block$dataset === void 0 ? void 0 : _block$dataset.postId;
  const rating = block === null || block === void 0 ? void 0 : (_block$dataset2 = block.dataset) === null || _block$dataset2 === void 0 ? void 0 : _block$dataset2.rating;
  if (postID && rating) {
    (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.render)((0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(ReviewRating, {
      postID: postID,
      rating: rating
    }), block);
  }
