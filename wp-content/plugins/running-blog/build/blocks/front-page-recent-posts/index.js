...
/***/ "./src/blocks/front-page-recent-posts/main.css":
/*!*****************************************************!*\
  !*** ./src/blocks/front-page-recent-posts/main.css ***!
  \*****************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/***/ "./src/blocks/front-page-recent-posts/block.json":
/*!*******************************************************!*\
  !*** ./src/blocks/front-page-recent-posts/block.json ***!
  \*******************************************************/
/***/ (function(module) {

module.exports = JSON.parse('{"$schema":"https://raw.githubusercontent.com/WordPress/gutenberg/trunk/schemas/json/block.json","apiVersion":2,"name":"running-blog/front-page-recent-posts","title":"Front Page Recent Posts","category":"text","description":"Adds a list of recent posts in the front page format","textdomain":"running-blog","attributes":{"title":{"type":"string","default":"Recent Posts"},"count":{"type":"number","default":5}},"editorScript":"file:./index.js"}');
...
!function() {
/*!*****************************************************!*\
  !*** ./src/blocks/front-page-recent-posts/index.js ***!
  \*****************************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _wordpress_element__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @wordpress/element */ "@wordpress/element");
/* harmony import */ var _wordpress_element__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__);
...
/* harmony import */ var _main_css__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./main.css */ "./src/blocks/front-page-recent-posts/main.css");
/* harmony import */ var _wordpress_data__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! @wordpress/data */ "@wordpress/data");
/* harmony import */ var _wordpress_data__WEBPACK_IMPORTED_MODULE_7___default = /*#__PURE__*/__webpack_require__.n(_wordpress_data__WEBPACK_IMPORTED_MODULE_7__);
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./block.json */ "./src/blocks/front-page-recent-posts/block.json");
...
(0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_1__.registerBlockType)(_block_json__WEBPACK_IMPORTED_MODULE_8__.name, {
  ...
  edit(_ref) {
    ...
    // categories
    const categories = (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_7__.useSelect)(select => {
      return select("core").getEntityRecords("taxonomy", "category");
    }, [count]);

    // tags
    const tags = (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_7__.useSelect)(select => {
    ...
    return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2__.InspectorControls, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_4__.PanelBody, {
      title: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)("Recent Posts", "running-blog")
      ...
      placeholder: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)("Title", "running-blog")
    }), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("section", {
      id: "front-page-latest-posts",
      class: "md:w-[28%] md:px-4"
    }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("h3", {
      class: "text-xl font-bold border-b light-text pb-2"
    }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("a", {
      href: "/posts",
      class: "bold-link marker"
    }, " ", "Recent", " ")), posts === null || posts === void 0 ? void 0 : posts.map((post, index) => {
      const {
        tags: tagsIdsArray
      } = post;
      const {
      ...
      return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("article", {
        className: `my-4 pb-4 ${index !== posts.length - 1 ? "border-b" : ""}`
      }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("p", {
        className: "float-right light-text handwriting"
      }, new Date(post.date).toLocaleDateString(undefined, {
        month: "short",
        day: "numeric"
      })), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("h4", null, categoryInfoArray.map(categoryInfo => {
      ...
      }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.RawHTML, null, post.excerpt.rendered))), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("p", null, tagInfoArray.map(tagInfo => {
