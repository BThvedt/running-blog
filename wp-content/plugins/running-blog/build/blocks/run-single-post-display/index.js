...
/***/ "./src/blocks/run-single-post-display/block.json":
/*!*******************************************************!*\
  !*** ./src/blocks/run-single-post-display/block.json ***!
  \*******************************************************/
/***/ (function(module) {

module.exports = JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":2,"name":"running-blog/run-single-post-display","title":"Run Single Post Display","description":"The displa for a single run post","keywords":["header"],"version":"1","textdomain":"running-blog","editorScript":"file:./index.js","attributes":{},"style":"file:./index.css"}');
...
!function() {
/*!*****************************************************!*\
  !*** ./src/blocks/run-single-post-display/index.js ***!
  \*****************************************************/
__webpack_require__.r(__webpack_exports__);
...
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./block.json */ "./src/blocks/run-single-post-display/block.json");
...
(0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_2__.registerBlockType)(_block_json__WEBPACK_IMPORTED_MODULE_4__.name, {
  ...
  edit(_ref) {
    ...
    }, blockProps), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)("p", null, "This is the run single post display"), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)("p", null, "The data will be rendered on the back end and displayed on the post.")));
  }
});
}();
/******/ })()
